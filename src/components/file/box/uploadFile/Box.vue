...
export default {
  data() {
    return {
      ...
      options: {
        ...
        chunkSize: 1024 * 1024 * 1024 * 100, //  每个分片的大小
  ...
  methods: {
    ...
    handlePrepareUpload() {
      ...
      console.log('headers中的token: ' + this.options.headers.token)
    ...
    handleFileSuccess(rootFile, file, response) {
      ...
      if (result.code == 0) {
        ...
        console.log('Box.vue 中，上传失败')
        console.log('上传失败时候headers中的token: ' + this.getCookies('token'))
